  ...
  else if (g_application.GetCurrentPlayer() == PCID_DSPLAYER)
  {
    ...
    { 
      ...
      for (unsigned int i = 0; i < countof(MadvrDeintActive); i++)
        entries.push_back(make_pair(MadvrDeintActive[i].label, i));
      ...
      for (unsigned int i = 0; i < countof(MadvrDeintForce); i++)
        entries.push_back(make_pair(MadvrDeintForce[i].label, i));
      ...
      for (unsigned int i = 0; i < countof(MadvrDeband); i++)
        entries.push_back(make_pair(MadvrDeband[i].label, i));
      ...
      for (unsigned int i = 0; i < countof(MadvrSmoothMotion); i++)
        entries.push_back(make_pair(MadvrSmoothMotion[i].label, i));
      ...
      for (unsigned int i = 0; i < countof(MadvrDithering); i++)
        entries.push_back(make_pair(MadvrDithering[i].label, i));
